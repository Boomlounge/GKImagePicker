Pod::Spec.new do |s|
  ...
  s.homepage       =  'https://github.com/sebcode/AKImagePicker'
  s.author         =  { 'Georg Kitz' => 'info@aurora-apps.com', 'Ahmed Khalaf' => 'ahmed@arkuana.co' }
  s.source         =  { :git => 'https://github.com/sebcode/GKImagePicker.git', :tag => s.version.to_s }
